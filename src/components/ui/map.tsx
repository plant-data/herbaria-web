...
function MapDrawControl({
  ...
  onFeatureGroupReady?: (featureGroup: L.FeatureGroup) => void
}) {
  const map = useMap()
...
function MapDrawShapeButton<T extends Draw.Feature>({
  ...
  createDrawTool: (leaflet: typeof L, map: DrawMap) => T
}) {
...
function MapDrawActionButton<T extends EditToolbar.Edit | EditToolbar.Delete>({
  ...
  createDrawTool: (leaflet: typeof L, map: DrawMap, featureGroup: L.FeatureGroup) => T
  ...
  }, [map, isActive, featureGroup, createDrawTool])
...
function MapDrawEdit({
  ...
  return (
    <MapDrawActionButton
      ...
      createDrawTool={(_L, map, featureGroup) =>
